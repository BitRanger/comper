...
import org.blacklancer.comper.feature.builder.IHtmlGen;
...
//		menuView = new JMenu("视图");
		...
		itemModifyQuestion = new JMenuItem("查看题目");
		...
		itemModifCHapter = new JMenuItem("查看知识点");
...
//				frame.add(new Modify());
		...
		itemModifyPaper = new  JMenuItem("查看试卷");
